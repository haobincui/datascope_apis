...
#                                             view=view,
#                                             number_of_levels=nums_of_levels)
extractioners = [TickHistoryMarketDepthExtractor(instrument, content_field_names, condition) for instrument in
                 instrument_list]

# extractioner_1 = TickHistoryMarketDepthExtractor(instrument_list,
#                                                     content_field_names,
#                                                     condition)
...
#                                             number_of_levels=nums_of_levels)
#
# extractioner_2 = TickHistoryMarketDepthExtractor(instrument_list,
#                                                     content_field_names,
#                                                     condition)
...
#                                             number_of_levels=nums_of_levels)
#
# extractioner_3 = TickHistoryMarketDepthExtractor(instrument_list,
#                                                     content_field_names,
#                                                     condition)
