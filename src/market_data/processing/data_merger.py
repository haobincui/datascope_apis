...
from src.connection.utils.file_processor.file_processor import FileProcesser
...
def remove_empty_rows(raw_data: pd.DataFrame, start_header: str = None):
    ...
    Args:
        raw_data (pd.DataFrame): Input value for raw data.
        start_header (str): Input value for start header.
...
class DataMerger:
    ...
    def future_data_merge(input_path: str, output_path: str, contract_path: str,
        ...
        Args:
            input_path (str): Input value for input path.
            output_path (str): Output directory or file path.
            contract_path (str): Input value for contract path.
            contract_termination_rule (ContractTerminationRule): Input value for contract termination rule.
            calendars (List[Calendar]): Input value for calendars.
        ...
        def _date_to_maturity(contract_name_col, data_date_col):
            ...
            Args:
                contract_name_col (object): Input value for contract name col.
                data_date_col (object): Input value for data date col.
