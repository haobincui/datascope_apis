...
class ExtractionBaseEnums(Enum):
    """Represents extraction base enums."""
    pass
...
class CorporateActionsCapitalChangeType(ExtractionBaseEnums):
    """Represents corporate actions capital change type."""
...
class CorporateActionsDividendsType(ExtractionBaseEnums):
    """Represents corporate actions dividends type."""
...
class CorporateActionsNominalValueType(ExtractionBaseEnums):
    """Represents corporate actions nominal value type."""
    NominalValueDate = 0


class CorporateActionsSharesType(ExtractionBaseEnums):
    """Represents corporate actions shares type."""
    SharesAmountDate = 0


class CorporateActionsStandardEventsEypes(ExtractionBaseEnums):
    """Represents corporate actions standard events eypes."""
    CAP = 0
    DIV = 1
    EAR = 2
    MNA = 3
...
class CorporateActionStandardYearType(ExtractionBaseEnums):
    """Represents corporate action standard year type."""
    Current = 0
    Previous = 1


class CorporateActionsVotingRightsType(ExtractionBaseEnums):
    """Represents corporate actions voting rights type."""
    VotingRightsDate = 0


class CriteriaListType(ExtractionBaseEnums):
    """Represents criteria list type."""
    Commodities = 0
    DTC = 1
...
class FidDisplayOptions(ExtractionBaseEnums):
    """Represents fid display options."""
    All = 0
    Matching = 1


class FidListOperators(ExtractionBaseEnums):
    """Represents fid list operators."""
    AND = 0
    OR = 1


class FixedIncomeRatingSource(ExtractionBaseEnums):
    """Represents fixed income rating source."""
    Fitch = 0
    Moodys = 1
    StandardAndPoors = 2
    NONE = 9
...
class FundAllocationTypes(ExtractionBaseEnums):
    """Represents fund allocation types."""
    Asset = 0
    Currency = 1
    DebtorDomicile = 2
    FullHoldings = 3
...
class FuturesAndOptionsType(ExtractionBaseEnums):
    """Represents futures and options type."""
    Futures = 0
    Options = 1
    FuturesOnOptions = 2
...
class HistoricalFiscalYearType(ExtractionBaseEnums):
    """Represents historical fiscal year type."""
    FYNegative1 = 0
    FYNegative2 = 1
    FYNegative3 = 2
    FYNegative4 = 3
...
class HistoricalQuarterType(ExtractionBaseEnums):
    """Represents historical quarter type."""
    QNegative1 = 0
    QNegative2 = 1
    QNegative3 = 2
    QNegative4 = 3
...
class HistoricalSemiAnnualType(ExtractionBaseEnums):
    """Represents historical semi annual type."""
    SNegative1 = 0
    SNegative2 = 1
    SNegative3 = 2
    SNegative4 = 3
...
class IssuerAssetClassType(ExtractionBaseEnums):
    """Represents issuer asset class type."""
...
class NewsItemsLanguageType(ExtractionBaseEnums):
    """Represents news items language type."""
    AllLanguages = 0
    English = 1
    Selected = 2
...
class NewsItemsSourceType(ExtractionBaseEnums):
    """Represents news items source type."""
    AllNews = 0
    ReutersNews = 1
    Selected = 2
...
class PremiumPricingRegionCycle(ExtractionBaseEnums):
    """Represents premium pricing region cycle."""
...
class RelativeFiscalYearType(ExtractionBaseEnums):
    """Represents relative fiscal year type."""
    FY1 = 1
    FY2 = 2
    FY3 = 3
    FY4 = 4
...
class RelativeQuarterType(ExtractionBaseEnums):
    """Represents relative quarter type."""
    Q1 = 1
    Q2 = 2
    Q3 = 3
    Q4 = 4
...
class RelativeSemiAnnualType(ExtractionBaseEnums):
    """Represents relative semi annual type."""
    S1 = 1
    S2 = 2
    S3 = 3
    S4 = 4
...
class ReportIsoEventType(ExtractionBaseEnums):
    """Represents report iso event type."""
    ACTV = 0
    BIDS = 1
    BONU = 2
    BPUT = 3
...
class ShareAmountChoice(ExtractionBaseEnums):
    """Represents share amount choice."""
    All = 1
    Default = 2
    Subset = 3
    NONE = 0
...
class TriggerTimeoutDay(ExtractionBaseEnums):
    """Represents trigger timeout day."""
    CurrentDay = 0
    FollowingDay = 1


class ValidityStatus(ExtractionBaseEnums):
    """Represents validity status."""
    BadInstrumentType = 0
    ChainHasBadLinks = 1
    ChainNotPermitted = 2
    ChainNotReviewed = 3
...
class ReportTemplateTypes(ExtractionBaseEnums):
    """Represents report template types."""
    BondRatings = 1
    BondSchedules = 2
