...
```python
from src.connection.infra.http import post_extractions_request
...
```python
from src.connection.infra.http import get_job_id_by_location
...
```python
from src.connection.infra.http import get_extraction_data_by_job_id
...
```python
from src.connection.infra.http import get_extraction_result_value
