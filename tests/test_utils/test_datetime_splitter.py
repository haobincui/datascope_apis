...
from src.calendar.datetime_splitter import DatetimeSplitter, DateSplitPartUnit
...
class TestDatetimeSplitter(unittest.TestCase):
    ...
    def test_datetime_spliter_by_year(self):
        ...
        dates = DatetimeSplitter.split_by_parts(start, end, 5)

        start_time = datetime(2010, 1, 3, 10, 5, 0)
        end_time = datetime(2015, 1, 5, 11, 5)

        datetimes = DatetimeSplitter.split_by_parts(start_time, end_time, 5)
    ...
    def test_datetime_spliter_by_month(self):
        datetime_spliter = DatetimeSplitter()
        start = date(2021, 1, 2)
        end = date(2021, 5, 2)

        dates = DatetimeSplitter.split_by_parts(start, end, 4)

        start_time = datetime(2021, 1, 15, 10, 5, 0)
        end_time = datetime(2021, 5, 28, 10, 5, 0)

        datetimes = DatetimeSplitter.split_by_parts(start_time, end_time, 4)
    ...
    def test_get_parts(self):
        ...
        part_1 = DatetimeSplitter.get_parts(start_y, end_y)
        target_part_1 = 5
        parts.append(part_1)
        ...
        part_2 = DatetimeSplitter.get_parts(start_m, end_m)
        target_part_2 = 9 + 12
        parts.append(part_2)
        ...
        part_3 = DatetimeSplitter.get_parts(start_d, end_d, DateSplitPartUnit.DAY)
        ...
        part_4 = DatetimeSplitter.get_parts(start_d_2, end_d_2)
        target_part_4 = 32
        parts.append(part_4)
