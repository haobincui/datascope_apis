...
content_field_names = [quote_ask_price,
                       quote_ask_size,
                       quote_bid_size,
                       quote_bid_price]
#
...
for start_date, end_date in zip(query_start_dates, query_end_dates):
    for identifiers in identifiers_groups:
        try:
            os.mkdir(f'./output_docs/FF trades/{start_date.year}')
        except:
            pass
        extractioners = []
        cur_ids = []
        ...
        for identifier in identifiers:
            ...
            output_paths.append(f'./output_docs/FF trades/{start_date.year}/{identifier}/{cur_id}.csv.gz')
            try:
                os.mkdir(f'./output_docs/FF trades/{start_date.year}/{identifier}')
            except:
                pass
